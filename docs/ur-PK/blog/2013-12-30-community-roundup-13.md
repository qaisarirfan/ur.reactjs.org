...
> Rendering this takes 803ms for 10 iterations, hovering around 35 and 55ms for each data reload (that's 67% faster). You'll notice that the first load takes a little longer than successive loads, and the second load REALLY struggles - here, it's 433ms, which is more than half of the total time! <figure>[![](../images/blog/ngreact.png)](http://davidandsuzi.com/ngreact-react-components-in-angular/)</figure>
> 
